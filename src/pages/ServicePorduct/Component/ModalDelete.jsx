...
export default function ServiceProductModalDelete({ handleCloseModal, productData, isRefetch }) {
  ...
  return (
    <Modal>
      ...
      <div className="text-center text-gray-400 mb-12">
        Mmenghapus layanan <strong>{productData.name}</strong> tidak dapat diulang
      </div>
