...
export default function ServiceProductIndex() {
  ...
  const getProducts = async () => {
    try {
      const res = await getProduct(`?type=layanan`)
  ...
  if (isLoading) {
    ...
    return (
      <>
        {productDataDelete && (<>
          <ServiceProductModalDelete isRefetch={handleToggleRefetch} productData={productDataDelete} handleCloseModal={() => { handleToggleOpen(null) }} />
        </>
        )
        }
        <div>
